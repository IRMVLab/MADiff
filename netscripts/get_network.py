# Builds the HOI transformer branches used by training.
import torch
from networks.traj_decoder import TrajCVAE
from networks.affordance_decoder import AffordanceCVAE
from networks.transformer import ObjectTransformer, MyObjectTransformer
...
def get_my_network(args, num_frames_input=10, num_frames_output=4):

    net = MyObjectTransformer(src_in_features=args.src_in_features,
                              trg_in_features=args.trg_in_features,
                              num_patches=args.num_patches,
                              encoder_time_embed_type=args.encoder_time_embed_type,
                              decoder_time_embed_type=args.decoder_time_embed_type,
